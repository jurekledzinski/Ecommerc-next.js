...
export const Section404Page = styled('section')(({ theme }) => ({
  display: 'flex',
...
export const title404PageStyles = {
...
export const titleStatusCode404PageStyles = {
...
export const boxWrapper404PageStyles = {
  width: { xs: '95%', sm: '400px' },
};

export const btn404PageStyles = {
  display: 'block',
